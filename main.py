...
class BlogPost(db.Model):
    ...
    comments_blog = relationship("Comment", back_populates="parent_post")
...
def register():
    form = RegisterForm(email="example@mail.com")
    if form.validate_on_submit():
        ...
        if email:
            flash("You are already signed with this email, please log in")
            return redirect(url_for('login'))
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if log_user:
            ...
            flash("Email is not registered, please try again")
            return redirect(url_for('login'))
